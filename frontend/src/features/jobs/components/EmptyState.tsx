  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Card
          className={`max-w-2xl mx-auto mt-16 ${CARD_STYLES.className}`}
        ...
        >
          <CardContent className="pt-12 pb-12 text-center">
            ...
            <p className="text-[#676662] mb-8 max-w-md mx-auto">
              Start your interview preparation journey by adding your first job
              position. We'll help you practice and improve with AI-powered
              feedback.
            </p>
            <AddJobModal />
          </CardContent>
