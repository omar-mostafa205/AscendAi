...
export function FeedbackDialog({ sessionId, isOpen, onOpenChange }: FeedbackDialogProps) {
...
<DialogContent aria-describedby={undefined}className="w-[90vw] !max-w-6xl max-h-[90vh] overflow-y-auto bg-[#f5f2ef] border border-[#b9b1ab] rounded-2xl shadow-lg"
>
<h2 className="text-3xl font-serif mb-2 text-[#1f1f1f]">Interview Feedback</h2>
        ...
        {isLoading || !session ? (
          ...
          <div className="space-y-6">
            <Card className="bg-white/70 border-1 border-[#b9b1ab] rounded-2xl shadow-lg">
              <CardContent className="pt-6">
                <h3 className="text-xl font-medium text-[#1f1f1f] mb-2">Overall Score</h3>
            ...
            {feedback && scenarioType && scoreFields[scenarioType]?.length > 0 && (
              <Card className="bg-white/70 border-1 border-[#b9b1ab] rounded-2xl shadow-lg">
                <CardContent className="pt-6">
                  <h3 className="text-xl font-medium text-[#1f1f1f] mb-4">Score Breakdown</h3>
            ...
            <Card className="bg-white/70 border-1 border-[#b9b1ab] rounded-2xl shadow-lg">
              <CardContent className="pt-6 space-y-4">
                ...
                <div>
                  <h4 className="font-medium text-[#1f1f1f] mb-2">Areas to Improve</h4>
                  <ul className="list-disc pl-5 text-[#1f1f1f]">
                ...
                <div>
                  <h4 className="font-medium text-[#1f1f1f] mb-2">Recommendations</h4>
                  <ul className="list-disc pl-5 text-[#1f1f1f]">
                ...
                <div>
                  ...
                  <p className="text-[#1f1f1f] whitespace-pre-wrap">{feedback?.summary ?? ""}</p>
                </div>
              </CardContent>
            </Card>
